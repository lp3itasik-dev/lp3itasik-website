                    ...
                    <form method="POST" action="{{ route('links.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="grid gap-5 mb-4 md:grid-cols-3">
                            <div>
                                ...
                                <input type="text" name="code" id="code" placeholder="Tuliskan kode disini..."
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" placeholder="Tuliskan nama situs disini..."
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                                <p class="mt-1 text-xs text-gray-500">
                            ...
                            <div>
                                ...
                                <input type="text" name="url" id="url" placeholder="Tuliskan url situs disini..."
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                                <p class="mt-1 text-xs text-gray-500">
