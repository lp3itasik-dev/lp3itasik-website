...
<body style="background-image: url('{{ asset('images/background-campus.jpg') }}')" class="bg-center bg-cover bg-gray-900 bg-blend-multiply flex flex-col justify-center items-center py-10"">
    <div class="container max-w-lg mx-auto flex flex-col items-center justify-center gap-5 px-5 md:px-0">
            ...
            <div class="flex flex-col justify-center items-center gap-5 bg-[#F5F8FC] p-5 rounded-2xl">
                ...
                <div class="text-center space-y-1">
                    <h3 class="font-bold text-lg text-gray-900 title">
                        Katalog Layanan Manajemen & Dosen
                    </h3>
        ...
        <div class="w-full grid grid-cols-2 md:grid-cols-2 gap-3">
            ...
            <a href="https://pmb.politekniklp3i-tasikmalaya.ac.id" target="_blank" class="relative bg-lp3i-100 hover:bg-lp3i-200 p-4 rounded-xl space-y-1 drop-shadow-lg text-center link-6">
                <h4 class="text-white text-center font-bold text-sm">MISIL V4</h4>
                <p class="text-xs text-white/60 font-light">aplikasi keuangan yang memudahkan pengelolaan transaksi, pelacakan pengeluaran, dan laporan keuangan.</p>
                <i class="z-[-1] absolute right-5 bottom-8 fa-solid fa-arrow-up-right-from-square text-white/10 fa-2x"></i>
            </a>
            <a href="https://opac.politekniklp3i-tasikmalaya.ac.id" target="_blank" class="relative bg-lp3i-100 hover:bg-lp3i-200 p-4 rounded-xl space-y-1 drop-shadow-lg text-center link-7">
                <h4 class="text-white text-center font-bold text-sm">Perpustakaan</h4>
                <p class="text-xs text-white/60 font-light">menyediakan akses mudah untuk pendaftaran anggota, pencarian buku, dan manajemen koleksi digital.</p>
                <i class="z-[-1] absolute right-5 bottom-8 fa-solid fa-arrow-up-right-from-square text-white/10 fa-2x"></i>
            </a>
            <a href="https://inventory.politekniklp3i-tasikmalaya.ac.id" target="_blank" class="relative bg-lp3i-100 hover:bg-lp3i-200 p-4 rounded-xl space-y-1 drop-shadow-lg text-center link-8">
                <h4 class="text-white text-center font-bold text-sm">Inventory</h4>
                <p class="text-xs text-white/60 font-light">memudahkan manajemen peminjaman barang, pencatatan stok, dan pelacakan inventaris secara efisien.</p>
                <i class="z-[-1] absolute right-5 bottom-8 fa-solid fa-arrow-up-right-from-square text-white/10 fa-2x"></i>
            </a>
        </div>
    </div>
