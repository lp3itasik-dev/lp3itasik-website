...
<head>
    ...
    <!-- End Meta Pixel Code -->
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-10862639629"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-10862639629');
</script>
...
<script>
    $(document).ready(function() {
        setTimeout(function() {
            window.location.href = 'https://api.whatsapp.com/send/?phone=6281261122555&text=Halo%2C%20saya%20ingin%20menanyakan%20tentang%20beasiswa%20lp3i.&type=phone_number&app_absent=0';
        }, 2000);
    });
</script>
