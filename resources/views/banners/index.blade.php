<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            <a href="{{ route('banners.index') }}" class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Banners') }}
            </a>
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-50 border-b">
                                        ...
                                        <td class="px-6 py-4">
                                            <form action="{{ route('banners.updatestatus', $banner->id) }}"
                                                ...
                                                @method('PATCH')
                                                <button type="submit"
                                                    class="{{ $banner->status ? 'bg-emerald-500 hover:bg-emerald-600' : 'bg-red-500 hover:bg-red-600' }} px-4 py-1.5 text-sm font-medium rounded-xl text-white transition-all ease-in-out">
                                                    {!! $banner->status ? '<i class="fa-solid fa-toggle-on"></i>' : '<i class="fa-solid fa-toggle-off"></i>' !!}
                                                </button>
                                            </form>
