                        ...
                        <div class="grid gap-5 mb-4 grid-cols-1 md:grid-cols-3">
                            <div>
                                ...
                                <select id="type" name="type"
                                    ...
                                    <option value="" disabled {{ empty($documentation->type) ? 'selected' : '' }}>Pilih
                                        Tipe</option>
                                    <option value="R" {{ $documentation->type === 'R' ? 'selected' : '' }}>Reguler
                                    </option>
                                    <option value="N" {{ $documentation->type === 'N' ? 'selected' : '' }}>Non-Reguler
                                    </option>
                                    <option value="RPL" {{ $documentation->type === 'RPL' ? 'selected' : '' }}>Rekognisi
